...
use App\Http\Controllers\MonthlyCalculationController;
...
Route::middleware([
    ...
    //routes for monthly calculation
    Route::get('/admin/monthly/calculation', [MonthlyCalculationController::class, 'showMonthlyCalculation'])->name('calculation.monthly')->middleware('auth:admin');
    Route::post('/admin/monthly/calculation', [MonthlyCalculationController::class, 'calculateMonthlyCalculation'])->name('calculate.monthly.calculation')->middleware('auth:admin');
});
