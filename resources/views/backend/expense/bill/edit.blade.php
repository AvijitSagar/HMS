                    ...
                    <div class="page-header">
                        ...
                        <div class="ms-auto pageheader-btn">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Bills Edit</li>
                            </ol>
                        </div>
                    </div>
                    <!-- PAGE-HEADER END -->
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" novalidate action="{{route('bill.update', [$bill->id])}}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                ...
                                                <input type="month" value="{{$bill->month_year}}" class="form-control" name="month_year" id="">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                ...
                                                <input name="electric_bill" value="{{$bill->electric_bill}}" type="number" class="form-control" id="electric_bill">
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                ...
                                                <input name="gas_bill" value="{{$bill->gas_bill}}" type="number" class="form-control" id="gas_bill">
                                                <p class="text-danger pt-2">{{$errors->has('gas_bill') ? $errors->first('gas_bill') : ''}}</p>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                <label for="water_bill">Water Bill</label>
                                                <input name="water_bill" value="{{$bill->water_bill}}" type="number" class="form-control" id="water_bill">
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                ...
                                                <input name="internet_bill" value="{{$bill->internet_bill}}" type="number" class="form-control" id="internet_bill">
                                                <p class="text-danger pt-2">{{$errors->has('internet_bill') ? $errors->first('internet_bill') : ''}}</p>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                <label for="dish_bill">Dish Bill</label>
                                                <input name="dish_bill" value="{{$bill->dish_bill}}" type="number" class="form-control" id="dish_bill">
                                                <p class="text-danger pt-2">{{$errors->has('dish_bill') ? $errors->first('dish_bill') : ''}}</p>
                                            </div>
                                        </div>
                                        <br>
                                        <button type="submit" class="btn btn-primary">Update Bill Expence</button>
                                        &nbsp;
