                    ...
                    <div class="page-header">
                        ...
                        <div class="ms-auto pageheader-btn">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Grocery Edit</li>
                            </ol>
                        </div>
                    </div>
                    <!-- PAGE-HEADER END -->
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" novalidate action="{{route('grocery.update', [$grocery->id])}}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <div id="datePickerStyle1" class="input-group date" data-date-format="dd-mm-yyyy">
                                                        ...
                                                        <input class="form-control" name="grocery_date" value="{{$grocery->grocery_date}}" id="" type="text"/>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                ...
                                                <input name="grocery_expense" type="number" value="{{$grocery->grocery_expense}}" class="form-control" id="grocery_expense">
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3">
                                                ...
                                                <textarea name="grocery_description" class="form-control" id="summernote" cols="30" rows="3">{{$grocery->grocery_description}}</textarea>
