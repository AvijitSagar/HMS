                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" novalidate action="{{route('meal-rate.calculate')}}" method="POST">
                                        @csrf
                                        ...
                                        <br>
                                        <button type="submit" class="btn btn-primary">Calculate Meal Rate</button>
                                    </form>
                                </div>
                            </div>
                        </div>
