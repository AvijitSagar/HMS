            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <div>
                            <h1 class="page-title">Meal Edit</h1>
                        </div>
                        <div class="ms-auto pageheader-btn">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Manage Meal</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Meal Edit</li>
                            </ol>
                        </div>
                    </div>
                    <!-- PAGE-HEADER END -->
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h3 class="card-title">Meal Edit</h3>
                                </div>
                                <div class="card-body">
                                    <p class="text-center text-success">{{ Session::get('msg') }}</p>
                                    <form class="needs-validation" novalidate action="{{route('meal.update', [$meal->id])}}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                ...
                                                <input type="month" class="form-control" name="month_year" value="{{$meal->month_year}}" id="">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                ...
                                                <select name="member_id" class="form-control" id="member_id">
                                                    ...
                                                    @foreach ($members as $member)
                                                        <option value="{{$member->id}}" {{$meal->member_id == $member->id ? 'selected' : ''}}>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                ...
                                                <input name="total_meal" type="number" value="{{$meal->total_meal}}" class="form-control" id="total_meal" required>
