            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="#" class="slide-item">Manage Members</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="#" class="slide-item">Add Bills</a></li>
                        <li><a href="#" class="slide-item">Manage Bills</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="#" class="slide-item">Member Wise Meals</a></li>
                        <li><a href="#" class="slide-item">Manage</a></li>
                    </ul>
                </li>
                <li class="slide">
