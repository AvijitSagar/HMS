                                                ...
                                                <div class="storage-percent">
                                                    <div class="progress fileprogress h-auto ps-0 shadow1">
                                                        ...
                                                        <span class="progress-bar progress-bar-xs wd-15p shared"
                                                            role="progressbar" aria-valuenow="25" aria-valuemin="0"
                                                            aria-valuemax="100"></span>
                                                        <span class="progress-bar progress-bar-xs wd-15p my-images"
                                                            role="progressbar" aria-valuenow="25" aria-valuemin="0"
                                                            aria-valuemax="100"></span>
                                                    </div>
                                    ...
                                    <div class="tl-container">
                                        <div class="tl-blog primary">
                                            ...
                                            <div class="tl-details d-flex">
                                                <p>
                                                    <span class="tl-title-main"> Mr White </span> Started following
                                                    you
                                            ...
                                            <tbody class="table-body">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <span class="data-image avatar avatar-md rounded-circle"
                                                                style="background-image: url({{ asset('/') }}backend/assets/images/users/11.jpg)"></span>
                                                        ...
                                                        <div class="form-group mb-0">
                                                            <ul>
                                                                <li class="select-status">
                                                                    <select class="form-control select2-status-search"
                                                                        data-placeholder="Select Status">
                                                                        <option value="IP" selected>In Progress
                                                                        </option>
                                                        ...
                                                        <div class="d-flex align-items-stretch">
                                                            <a class="btn btn-sm btn-outline-primary border me-2"
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    enable-background="new 0 0 24 24" height="20"
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <span class="data-image avatar avatar-md rounded-circle"
                                                                style="background-image: url({{ asset('/') }}backend/assets/images/users/12.jpg)"></span>
                                                            <div class="user-details ms-2">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <span class="data-image avatar avatar-md rounded-circle"
                                                                style="background-image: url({{ asset('/') }}backend/assets/images/users/13.jpg)"></span>
                                                            <div class="user-details ms-2">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <span class="data-image avatar avatar-md rounded-circle"
                                                                style="background-image: url({{ asset('/') }}backend/assets/images/users/4.jpg)"></span>
                                                            <div class="user-details ms-2">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <span class="data-image avatar avatar-md rounded-circle"
                                                                style="background-image: url({{ asset('/') }}backend/assets/images/users/5.jpg)"></span>
                                                            <div class="user-details ms-2">
                                                    ...
                                                    <td class="text-muted fs-14 fw-semibold"><a href="#"
                                                            class="text-dark" data-bs-target="#Vertically"
                                                            data-bs-toggle="modal">Rebum gubergren at kasd takimata
                                                            clita.</a></td>
                                                    <td class="text-muted fs-13"><a href="project-details.html"
                                                            class="text-dark">Noa Dashboard UI</a></td>
