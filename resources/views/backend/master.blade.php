                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="argentina"
                                            src="{{ asset('/') }}backend/assets/images/flags/argentina_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="uae"
                                            src="{{ asset('/') }}backend/assets/images/flags/uae_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="austria"
                                            src="{{ asset('/') }}backend/assets/images/flags/austria_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="mexico"
                                            src="{{ asset('/') }}backend/assets/images/flags/mexico_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="china"
                                            src="{{ asset('/') }}backend/assets/images/flags/china_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="poland"
                                            src="{{ asset('/') }}backend/assets/images/flags/poland_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="canada"
                                            src="{{ asset('/') }}backend/assets/images/flags/canada_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="malaysia"
                                            src="{{ asset('/') }}backend/assets/images/flags/malaysia_flag.jpg"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="{{ asset('/') }}backend/assets/images/users/11.jpg">
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-lg"
                                                                src="{{ asset('/') }}backend/assets/images/users/14.jpg">
                                                        </div>
                                                        <div>
